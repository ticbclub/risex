...
<main class="main">
<div class="newsticker" id="newsticker"><div class="nt-label">⚡ Live</div><div class="nt-feed"><div class="nt-track" id="nt_track">Loading activity feed…</div></div></div>
...
<div class="view active" id="v_overview">
 <div class="dailystory" id="dailystory">
  <div class="ds-icon">🌿</div>
  <div class="ds-content">
   <div class="ds-eyebrow">Today on RISEx</div>
   <div class="ds-text">Loading today's highlights…</div>
  </div>
  <div class="ds-cycle" onclick="cycleDailyStory()">→ next</div>
 </div>
 <div class="trending" id="trending_panel" style="display:none"></div>
